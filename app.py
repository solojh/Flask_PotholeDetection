...
model = load_model('C:/Users/Asus/Desktop/Flask/Pothole_path/model.h5')
...
def displayImage():
    ...
    for img_file_path in img_file_paths:
        ...
        if X is None or X.size == 0:
            predictions[img_file_path] = "Unable to read or empty image"
        else:
            predictions[img_file_path] = predict_pothole(X)
